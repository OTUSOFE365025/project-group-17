...
T3: Active Redundancy vs. cost/complexity <br>
T4: Performance vs. consistency <br>

Risk:<br>
R1: Cache warm-up lag<br>
R2: Stale/invalid cache Entries<br>
R3: Failover misconfig<br>
...
<table>
  ...
  <tr><td>Environment</td><td>System running as required; redundant servers, Monitoring tools, and maintenance in order.</td></tr>
  <tr><td>Response</td><td>Fault/maintenance Detected, users experience minimal disruption (<0.5% Availability), instant failover </td></tr>
</table>
